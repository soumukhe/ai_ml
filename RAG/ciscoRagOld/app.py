...
# Configure Streamlit to allow larger file uploads (1GB)
st.set_page_config(
    page_title="Cisco Documentation RAG",
    page_icon="📚",
    layout="wide",
...
with security_info:
    ...
    * Only your final questions are sent to Cisco's BridgeIT API
...
with tab1:
    ...
    # Get valid users once and reuse
    users = RAGSystem.get_all_users()
    user_ids = [user["user_id"] for user in users]
